...
class QuadTreeAlg {
    ...
    public QuadTreeAlg() {
        ...
        for (int i = 0; i < Qtree4Settings.settings.getNumberOfParticles(); i++) {
            final BouncingBall bouncingBall = new BouncingBall(HEIGHT, 1, 1, WIDTH, Qtree4Settings.settings.getMovementSpeed());
